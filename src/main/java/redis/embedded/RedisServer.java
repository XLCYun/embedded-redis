...
public class RedisServer extends AbstractRedisInstance {
    private static final String REDIS_READY_PATTERN = ".*The server is now ready to accept connections on port.*|.*Ready to accept connections.*|.*Ready to accept connections.*";
